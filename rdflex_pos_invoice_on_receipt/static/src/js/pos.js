odoo.define("pos_ticket_invoice_customer", function (require) {
            ...
            if (order.is_to_invoice()) {
                ...
                invoiced.done(function (orderId) {
                    ...
                    .then(function (number) {
                        ...
                        if(number && number[0]){
                            order.invoice_number = number[0];
                        }
                        if(number && number[1]){
                            var access_code_string = number[1].toString();
                            var final_access_code = [access_code_string.slice(0, 36), " ", access_code_string.slice(37)].join('');
                            console.log(final_access_code);
                            order.invoice_access_code = final_access_code;
                        }
    ...
    models.PosModel = models.PosModel.extend({
        push_and_invoice_order: function (order) {
            ...
            var not_print_invoice = this.config.not_print_invoice;
